...
export declare const innerStyle: ({ translate, dragging, mounted, transition, inertiaScrolling, rtl, }: InnerStyleProps) => CSSProperties;
...
export declare class InnerWrapper extends React.PureComponent<InnerWrapperProps, InnerWrapperState> {
    ...
    static isElementActive: (itemId: string | number | null, selected: string | number) => boolean;
