...
const Search = ({navigation}) => {
  ...
  //mikhastam inja start bashe vali warning midad va nafahmidam chera
    ...
    />
        ...
        <ScrollView style={{}}>
        {authorcount!=0?<AntDesign name="arrowleft" style={{marginTop:hp("3.7%"),position:"absolute",alignSelf:"flex-end",right:wp("4%")}} size={24} color="#1f7a8c" />:null}
        ...
        stylee={{}} title="جستجو بر اساس نویسنده"></ResultsList>:<ActivityIndicator style={{height:hp("39%")}} size={"small"} color={"gray"} ></ActivityIndicator>}
         ...
         ></Image>
            {titlecount!=0? <AntDesign name="arrowleft" style={{marginTop:hp("45.5%"),position:"absolute",alignSelf:"flex-end",right:wp("4%")}} size={24} color="#1f7a8c" />:null}
