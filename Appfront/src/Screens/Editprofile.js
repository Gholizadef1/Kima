...
const EditProfile = () => {
  ...
  const photoresponse=async ()=>{
    ...
    const response = await axiosinst.get("http://6124bc8043de.ngrok.io/api/user-profile/"+id)
  ...
  console.log('*****')
        ...
        console.log(`http://6124bc8043de.ngrok.io${response.data.profile_photo}`)
        setpicture(`http://6124bc8043de.ngrok.io${response.data.profile_photo}`)
        console.log(picture)
      
   console.log(response.data.profile_photo)
   console.log(!(picture==="http://6124bc8043de.ngrok.io/media/default.jpg"))
...
// const[pic,setpic]=useState('http://3097034fddc8.ngrok.io/media/profile_photos/test_spQxL7A.jpg')
    return(
      ...
      {picture==='http://6124bc8043de.ngrok.io/media/default.png'?<ImageBackground borderRadius={100}
