...
const EditProfile = () => {
  ...
  const photoresponse=async ()=>{
    ...
    const response = await axiosinst.get("http://cc4552eb4e3a.ngrok.io/api/user-profile/"+id)
  ...
  console.log('*****')
        ...
        console.log(`http://cc4552eb4e3a.ngrok.io${response.data.profile_photo}`)
        setpicture(`http://cc4552eb4e3a.ngrok.io${response.data.profile_photo}`)
        console.log(picture)
      
   console.log(response.data.profile_photo)
   console.log(!(picture==="http://cc4552eb4e3a.ngrok.io/media/default.jpg"))
  ...
  const pickfromgallery = async ()=>{
    ...
    console.log('gallery')
      ...
      if(granted){
          ...
          const response=await axiosinst.put('http://cc4552eb4e3a.ngrok.io/api/update-profile/',formdata,{
...
// const[pic,setpic]=useState('http://3097034fddc8.ngrok.io/media/profile_photos/test_spQxL7A.jpg')
    return(
      ...
      {picture==='http://cc4552eb4e3a.ngrok.io/media/default.png'?<ImageBackground borderRadius={100}
