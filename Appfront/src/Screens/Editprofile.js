...
const EditProfile = () => {
  ...
  const photoresponse=async ()=>{
    ...
    // console.log(id)
    try{
    const response = await axiosinst.get("http://dd0613066c67.ngrok.io/api/user-profile/"+id)
        
    
  //  console.log(response)
  console.log('*****')
        console.log(`http://dd0613066c67.ngrok.io${response.data.profile_photo}`)
        setpicture(`http://dd0613066c67.ngrok.io${response.data.profile_photo}`)
        console.log(picture)
      
   console.log(response.data.profile_photo)
   console.log(!(picture==="http://dd0613066c67.ngrok.io/media/default.jpg"))
  ...
  const pickfromgallery = async ()=>{
    ...
    console.log('gallery')
      ...
      if(granted){
          ...
          const response=await axiosinst.put('http://dd0613066c67.ngrok.io/api/update-profile/',formdata,{
            headers:{
...
// const[pic,setpic]=useState('http://3097034fddc8.ngrok.io/media/profile_photos/test_spQxL7A.jpg')
    return(
      ...
      {picture==='http://dd0613066c67.ngrok.io/media/default.png'?<ImageBackground borderRadius={100}
      ...
      validationSchema={userschema}
        ...
        const response=await axiosinst.put('http://dd0613066c67.ngrok.io/api/update-profile/',backk,{
          headers:{
            "Content-Type":"application/json",
            "Authorization":"Token "+(await AsyncStorage.getItem('token')).toString()}
          }
     ...
     <Formik style={{borderStyle:'dashed',justifyContent:'space-around'}}
      ...
      validationSchema={passschema}
        ...
        const response=axiosinst.put('http://dd0613066c67.ngrok.io/api/change-password/',backk,{
          headers:{
            "Content-Type":"application/json",
            "Authorization":"Token "+(await AsyncStorage.getItem('token')).toString()},
          })
