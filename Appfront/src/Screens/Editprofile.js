...
const EditProfile = () => {
  ...
  console.log('*****')
        console.log(`http://ca6eb39ce4c3.ngrok.io${response.data.profile_photo}`)
        setpicture(`http://ca6eb39ce4c3.ngrok.io${response.data.profile_photo}`)
        console.log(picture)
      
   console.log(response.data.profile_photo)
   console.log(!(picture==="http://ca6eb39ce4c3.ngrok.io/media/default.jpg"))
...
// const[pic,setpic]=useState('http://3097034fddc8.ngrok.io/media/profile_photos/test_spQxL7A.jpg')
    return(
      ...
      {picture==='http://ca6eb39ce4c3.ngrok.io/media/default.png'?<ImageBackground borderRadius={100}
