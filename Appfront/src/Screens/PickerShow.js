...
export default class PickerShow extends Component {
  ...
  render() {
    ...
    const addBookToMineHandler = async(getValue)=>{
      ...
      axios.post('http://dbe797f728d2.ngrok.io/bookdetail/'+this.props.bookid,back,{
    ...
    async function getbookstate(){
      axiosinst.get('http://dbe797f728d2.ngrok.io/bookdetail/'+this.props.bookid+'/getstate',{"headers":{"content-type":"application/json",
            "Authorization":"Token "+(await AsyncStorage.getItem('token')).toString()
            }})
