...
//       axios.post('http://92a8f1ce7b76.ngrok.io/bookdetail/'+this.props.bookid,back,{
...
//       axiosinst.get('http://92a8f1ce7b76.ngrok.io/bookdetail/'+this.props.bookid+'/getstate',{"headers":{"content-type":"application/json",
//             "Authorization":"Token "+(await AsyncStorage.getItem('token')).toString()
//             }})
