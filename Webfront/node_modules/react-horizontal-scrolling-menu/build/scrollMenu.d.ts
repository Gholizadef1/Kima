...
export declare class ScrollMenu extends React.Component<MenuProps, MenuState> {
    ...
    getLastPageOffset: ({ items, allItemsWidth, menuWidth, }: {
        items: MenuItems;
        allItemsWidth: number;
        menuWidth: number;
    }) => number;
    getPagesOffsets: ({ items, allItemsWidth, menuWidth, offset, }: {
        items?: MenuItems | undefined;
    ...
    getItemInd: (menuItems: MenuItems | undefined, item: MenuItem) => number;
    ...
    getOffset: (left: boolean, items?: MenuItems) => number;
    ...
    handleDragWrapper: (e: React.MouseEvent | React.TouchEvent | Event) => Void;
    handleDrag: (e: React.MouseEvent | React.TouchEvent | Event) => Void;
    handleDragStopWrapper: (e: Event) => Void;
